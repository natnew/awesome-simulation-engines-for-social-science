...
- [Iwanaga, Usher & Herman — Toward SALib 2.0: Advancing the accessibility and interpretability of global sensitivity analyses (Socio-Environmental Systems Modelling 2022)](https://sesmo.org/article/view/18155) `tool` — Python library implementing Sobol, Morris, FAST, delta, and PAWN sensitivity analyses, for finding which simulator parameters drive which outcomes before costly calibration.
